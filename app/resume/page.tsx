...
// NOTE: ResumePDF uses @react-pdf/renderer which has top-level await (ESM-only).
// It's dynamically imported in the download handler to avoid breaking Turbopack SSR.
import {
  saveResume,
  getCurrentUser,
