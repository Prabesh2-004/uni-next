...
const s: Record<string, React.CSSProperties> = {
  ...
  contact: { fontSize: 15, opacity: 0.9 },
  body: {
    display: "flex",
    minHeight: 900,
  },
  ...
  plainItem: { fontSize: 15, color: "#374151", marginBottom: 3 },
  sideTitle: { fontWeight: 700, fontSize: 15, margin: "0 0 1px", color: "#1e293b" },
  sideOrg: { fontSize: 15, color: "#374151", margin: 0 },
  sideMeta: { fontSize: 14, color: "#6b7280", margin: 0 },
  paragraph: { fontSize: 16, lineHeight: 1.65, color: "#374151", margin: 0 },
  ...
  entryTitle: { fontWeight: 700, fontSize: 15, margin: 0, color: "#1e293b" },
  entryOrg: { fontSize: 13, color: "#4b5563", margin: 0 },
  entryDate: {
    fontSize: 12,
    color: "#6b7280",
    background: "#f1f5f9",
